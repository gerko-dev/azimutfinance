...
import {
  ...
  fmtPct,
  pnlColor,
} from "@/components/outils/portefeuille/format";
import { pageMetadata } from "@/lib/seo";

export const metadata = pageMetadata({
  title: "Mon portefeuille — AzimutFinance",
  description:
    "Suivez votre portefeuille BRVM au quotidien : positions, PRU, plus-values latentes et réalisées, courbe de valorisation et allocation. Réservé aux membres.",
        ...
        <main className="max-w-3xl mx-auto px-4 md:px-6 py-12 md:py-16">
          <div className="bg-white rounded-lg border border-slate-200 p-6 md:p-10 text-center">
            <div className="text-[11px] uppercase tracking-wider text-slate-500 font-semibold">
              Outils · Mon portefeuille
            </div>
            <h1 className="text-2xl md:text-3xl font-semibold text-slate-900 mt-2">
              Suivez votre portefeuille BRVM — réservé aux membres
            </h1>
