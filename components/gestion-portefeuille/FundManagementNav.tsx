...
const ITEMS: ModuleNavItem[] = [
  { label: "Vue d'ensemble", href: "/gestion-portefeuille" },
  { label: "Fonds gérés", href: "/gestion-portefeuille/fonds" },
  { label: "Investisseurs", href: "/gestion-portefeuille/investisseurs", soon: true },
  { label: "Reporting", href: "/gestion-portefeuille/reporting" },
  { label: "Paramètres", href: "/gestion-portefeuille/parametres" },
];
...
export default function FundManagementNav() {
  ...
  return (
    <nav className="border-b border-slate-800 flex gap-1 overflow-x-auto -mt-1 mb-5">
      {ITEMS.map((item) => {
        const active =
          item.href === "/gestion-portefeuille"
            ? pathname === item.href
